<h1 align="center">LVS Task 1 – Baseline Model - Optimized to run in ONNX Runtime</h1>
...
This branch has an optimized ONNX model for edge deployment.

The repository includes:

- Inference using `parking_detector.onnx`
...
```bash
git clone -b feature/inference-onnx https://github.com/scouring/LVS-Task-1.git
cd LVS-Task-1
```
